        ...
        switch(choice) {
            ...
            case 6:
                ...
                cout << "Lo primero que tienes que hacer es registrarte, para eso presiona 1." << endl
                     ...
                     << "por último, si quieres chatear con alguien, ingresa la opción 4, escribe el nombre del destinatario o bien 'everyone' para enviar un mensaje a todos los usuarios conectados"
                break;
            case 7:
                // ==================================
                // Salir
